# -*- coding: utf-8 -*-
"""Covid_19NormedDeathsStateDataD.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/174WBhWYUOs5SthAgAGunrQfTLlfnLjfo
"""
...
shap.force_plot(explainer.expected_value, 
                shap_values[i], 
#                features=X_train_shap_encoded.loc[i],
                features=X_train.loc[i],
#                feature_names=X_train_shap_encoded.columns)
...
layout = go.Layout(
        scene=dict(
                 xaxis=dict(title= ''),
                 yaxis=dict(title= 'Value of d for state'),
